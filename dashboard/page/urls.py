...
urlpatterns = [
    ...
    path('manage_PagePosition/', views.manage_PagePosition, name='manage_PagePosition'),
    path('edit_PagePosition/<int:PagePosition_id>/', views.edit_PagePosition, name='edit_PagePosition'),
    path('delete_PagePosition/<int:PagePosition_id>/', views.delete_PagePosition, name='delete_PagePosition'),
    path('page_content_list/', views.page_content_list, name='page_content_list'),
    path('manage_page_content/', views.manage_page_content, name='manage_page_content'),
    path('edit_page_content/<int:content_id>/', views.edit_page_content, name='edit_page_content'),
    path('delete_page_content/<int:content_id>/', views.delete_page_content, name='delete_page_content'),
